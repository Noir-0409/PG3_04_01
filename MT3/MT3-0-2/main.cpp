...
//転置行列
Matrix4x4 Transpone(const Matrix4x4& m) {
...
const char kWindowTitle[] = "MT3-0-2";
...
int WINAPI WinMain(HINSTANCE, HINSTANCE, LPSTR, int) {
	...
	while (Novice::ProcessMessage() == 0) {
        ...
        Matrix4x4 transponeM1 = Transpone(m1);
        Matrix4x4 transponeM2 = Transpone(m2);
        ...
        MatrixScreenPrintf(kColumnWidth * 6, 0, transponeM1, "transponeM1");
        MatrixScreenPrintf(kColumnWidth * 6, kRowHeight * 5, transponeM2, "transponeM2");
        MatrixScreenPrintf(kColumnWidth * 6, kRowHeight * 5 * 2, identity, "identity");
