...
void DrawTriangle(const Triangle& triangle, const Matrix4x4& viewProjectionMatrix, const Matrix4x4& viewportMatrix, uint32_t color) {
	...
	// 三角形の各頂点を変換
	Vector3 v0 = viewportMatrix * (viewProjectionMatrix * triangle.vertices1);
	Vector3 v1 = viewportMatrix * (viewProjectionMatrix * triangle.vertices2);
	Vector3 v2 = viewportMatrix * (viewProjectionMatrix * triangle.vertices3);

	// 各辺を描画
	Novice::DrawLine(static_cast<int>(v0.x), static_cast<int>(v0.y),
	...
	Novice::DrawLine(static_cast<int>(v2.x), static_cast<int>(v2.y),
...
bool IsCollision(const Triangle& triangle, const Segment& segment) {
	...
	// 三角形の頂点
	Vector3 v0 = triangle.vertices1;
	Vector3 v1 = triangle.vertices2;
	Vector3 v2 = triangle.vertices3;
	...
	// 線分の終点
	Vector3 q = segment.origin + segment.diff;
