...
int WINAPI WinMain(HINSTANCE, HINSTANCE, LPSTR, int) {
	...
	Sphere sphere1{ {0.0f, 0.5f, 0.0f}, 0.5f };

	Sphere sphere2{ {1.0f,0.5f,0.0f},0.3f };
	...
	while (Novice::ProcessMessage() == 0) {
		...
		DrawSphere(sphere2, worldViewProjectionMatrix, viewPortMatrix, sphere2Color);

		Novice::ScreenPrintf(10, 10, "%d", IsCollision(sphere1,sphere2));
