...
int WINAPI WinMain(HINSTANCE, HINSTANCE, LPSTR, int) {
	...
	while (Novice::ProcessMessage() == 0) {
		...
		// 画像の描画
		Novice::DrawSprite(440 - r, 360 - r, particle, 1.0f, 1.0f, 0.0f, color);

		Novice::DrawSprite(640 - r, 360 - r, particle, 1.0f, 1.0f, 0.0f, color);

		Novice::DrawSprite(840 - r, 360 - r, particle, 1.0f, 1.0f, 0.0f, color);

		Novice::DrawSprite(posX - r, posY - r, particle, 1.0f, 1.0f, 0.0f, color);
